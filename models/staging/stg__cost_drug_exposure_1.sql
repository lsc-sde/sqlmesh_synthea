...
select distinct
  ...
  e.total_claim_cost + i.base_cost as total_charge,
  e.total_claim_cost + i.base_cost as total_cost,
  e.payer_coverage + i.base_cost as total_paid,
  e.payer_coverage as paid_by_payer,
  e.total_claim_cost + i.base_cost - e.payer_coverage as paid_by_patient,
...
inner join @schema_omop.drug_exposure as de
  on
    i.code::varchar = de.drug_source_value
